        ...
        >
            ...
            >
                <div className="d-flex justify-content-between align-items-center mb-2">
                    <small className="text-uppercase fw-bold text-dark-emphasis">
                        Pokémon
                    </small>

                    <span className="badge rounded-pill bg-light text-dark px-2 py-1">
                        {name}
                    </span>
                </div>

                <div className="d-flex justify-content-center align-items-center rounded-circle bg-white bg-opacity-25 mx-auto"
            ...
            <Card.Body className="p-3">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <Card.Title className="text-uppercase fw-bold text-dark mb-0">
                        {name}
                    </Card.Title>
                </div>
                ...
                <div className="d-flex flex-wrap gap-2 mb-3">
                    {types.map((tipo) => (
                        <span
                            ...
                            style={{
                                backgroundColor: typeColors[tipo.type.name] ?? "#6c757d",
                            }}
                        >
                            {tipo.type.name}
                        </span>
